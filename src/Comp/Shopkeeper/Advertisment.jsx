...
export default function Advertisment() {
    ...
    useEffect(() => {
        ...
        axios.get("https://apnidukan.onrender.com/api/carousel")
            .then((response) => {
    ...
    const handleFormSubmit = (e) => {
        ...
        axios.post("https://apnidukan.onrender.com/api/carousel", newCarouselItem)
            .then((response) => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(`https://apnidukan.onrender.com/api/carousel/${id}`)
            .then(() => {
